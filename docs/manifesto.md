...
## IV. The Directional Model

Features in annot flow in specific directions:

**AI → Human**: Tools that help humans comprehend what AI presents.
- Portals embed live code in context
- Highlights draw attention to what matters
- Callouts provide semantic emphasis
- Diagrams visualize structure
...
Both directions serve the same goal: **high-bandwidth, high-fidelity communication** between human and AI.

---

## V. What annot Is Not

**Not a document editor.** The content is AI's to generate; the human shapes it through reaction, not authorship.
...
- **Rich** — diagrams, code references, semantic tags, not just text
- **Fluid** — roles shift, direction shifts, but the dialogue continues
- **Ephemeral** — the tool gets out of the way the moment it's not needed
- **Generative** — humans contribute expertise, not just approval

annot is not the only tool in this world. But it is the tool for **structured, located, high-bandwidth feedback** — the moment when human judgment meets AI output and something better emerges.
